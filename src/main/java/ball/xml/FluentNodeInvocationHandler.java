 ...
 * @version $Revision$
 */
public class FluentNodeInvocationHandler extends DefaultInvocationHandler {
    private final ProxyMap map = new ProxyMap();

    protected FluentNodeInvocationHandler() { super(); }
    ...
    private class ProxyMap extends IdentityHashMap<Object,Object> {
        private static final long serialVersionUID = -2521635828593566258L;
